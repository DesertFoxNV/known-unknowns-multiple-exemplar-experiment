...
export const KNOWN_COMBINATORIALLY_ENTAILED_OPERATOR_DICT: Record<any, Record<any, CueNonArbitrary>> =
  {
    ...
    [CUE_NON_ARBITRARY.lessThan]: {
      ...
      [CUE_NON_ARBITRARY.greaterThan]: CUE_NON_ARBITRARY.greaterThan,
      [CUE_NON_ARBITRARY.lessThan]: CUE_NON_ARBITRARY.lessThan // This is special we are assuming B < C here
    },
    [CUE_NON_ARBITRARY.greaterThan]: {
      [CUE_NON_ARBITRARY.same]: CUE_NON_ARBITRARY.lessThan,
      [CUE_NON_ARBITRARY.greaterThan]: CUE_NON_ARBITRARY.greaterThan, // This is special we are assuming B > C here
      [CUE_NON_ARBITRARY.lessThan]: CUE_NON_ARBITRARY.lessThan
    }
  };
