...
export const KNOWN_NETWORK_CUE_OPERATORS_SAME_GT_LT: TriNodeNetworkOperatorCombination<CueNonArbitrary>[] = [
  ...
  [CUE_NON_ARBITRARY.lessThan, CUE_NON_ARBITRARY.lessThan, CUE_NON_ARBITRARY.lessThan],
  ...
  [CUE_NON_ARBITRARY.greaterThan, CUE_NON_ARBITRARY.greaterThan, CUE_NON_ARBITRARY.greaterThan]
];
